    ...
    return (
        <div className='pt-5 bg-Background min-h-screen'>
            ...
            <div className='sm:flex sm:flex-row'>
                ...
                <div>
                    <button type="submit" className="flex mt-10 rounded-full bg-Background border border-Text px-14 py-2 text-Text mx-auto font-poppins font-bold">INSCRIPTION</button>
                </div>
                </Link>
