            ...
            <div className='sm:flex sm:flex-row'>
                ...
                <div className="relative z-0 mx-16 mt-8">
                    <input type="text" name=""
                           className="peer block w-full appearance-none rounded-b-none border-1 border-b border-white bg-transparent py-2.5 px-0 text-sm text-white focus:outline-none focus:ring-none"
                           placeholder=" "/>
                    <label
                ...
                <div className="relative z-0 mx-16 mt-8">
                    <input type="text" name=""
                           className="peer block w-full appearance-none rounded-b-none border-1 border-b border-white bg-transparent py-2.5 px-0 text-sm text-white focus:outline-none focus:ring-0"
                           placeholder=" "/>
                    <label
                        className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-white duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 ">
                        Prénom
