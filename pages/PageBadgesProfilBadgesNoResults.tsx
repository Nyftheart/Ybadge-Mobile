  ...
  return (
    <div className={'bg-Background min-h-screen'}>
      ...
      <div className={'flex justify-between mb-8'}>
        ...
        <div className={''}>
          <img src="/Recherche_Logo_Ybadges.png" width={100} height={100} alt="logo" className="m-auto mr-8" />
        </div>
      </div>

      <div className={'flex justify-between'}>
        <div className={'text-Text text-orange-500 ml-4 underline '}>MA COLLECTION</div>
